...
Scene1::Scene1(): _world(b2Vec2(0.0f, 100.0f)), _player(_world, toPixels(4.5), toPixels(16)), _deathsCount(0){
...
void Scene1::createMap() {
    ...
    _blocks.emplace_back(_world, toPixels(20), toPixels(16));
    _blocks.emplace_back(_world, toPixels(21), toPixels(16));

    _ramps.emplace_back(_world, toPixels(3), toPixels(4), true, false);
    _ramps.emplace_back(_world, toPixels(3), toPixels(8), true, true);
    _ramps.emplace_back(_world, toPixels(3), toPixels(13), true, false);
    _ramps.emplace_back(_world, toPixels(3), toPixels(16), true, true);
    _ramps.emplace_back(_world, toPixels(19), toPixels(16), false, true);
    ...
    /// Crear elevador
    _elevators.emplace_back(_world, toPixels(23), toPixels(9), 9.0f, 17.0f, 2.0f);


    /// Crear pinchos
    _spikes.emplace_back(_world, toPixels(13), toPixels(12.76), false);
    _spikes.emplace_back(_world, toPixels(14), toPixels(12.76), false);

    /// Crear botones
    _buttonOriginalPosition = b2Vec2(18.5f, 8.87f);

    _buttons.emplace_back(_world, toPixels(0), toPixels(0));

    /// Crear lasers
    _laserOriginalPosition = b2Vec2(13.5f, 6.5f);

    _lasers.emplace_back(_world, toPixels(0), toPixels(0), 5.0f);

    /// Crear llave
    _keyOriginalPosition = b2Vec2(27.0f, 16.2f);
    ...
    /// Crear puerta
    _door.emplace_back(_world, toPixels(6.5), toPixels(7.32));
    ...
    _levelImage.setTexture("resources/Sprites/bloqueNivel1.png");
