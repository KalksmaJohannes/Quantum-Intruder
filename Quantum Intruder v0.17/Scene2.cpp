...
Scene2::Scene2(): _world(b2Vec2(0.0f, 100.0f)), _player(_world, toPixels(4.5), toPixels(16)), _deathsCount(0){
...
void Scene2::createMap() {
    ...
    _blocks.emplace_back(_world, toPixels(23), toPixels(16));

    _ramps.emplace_back(_world, toPixels(3), toPixels(4), true, false);
    _ramps.emplace_back(_world, toPixels(3), toPixels(16), true, true);
    _ramps.emplace_back(_world, toPixels(18), toPixels(13), false, false);
    _ramps.emplace_back(_world, toPixels(20), toPixels(12), true, true);
    _ramps.emplace_back(_world, toPixels(21), toPixels(13), true, true);
    ...
    /// Crear elevadores
    _elevators.emplace_back(_world, toPixels(25), toPixels(7), 7.0f, 17.0f, 2.0f);
    ...
    /// Crear botones
    _buttonOriginalPosition = b2Vec2(17.5f, 6.87f);

    _buttons.emplace_back(_world, toPixels(0), toPixels(0));

    /// Crear lasers
    _laserOriginalPosition = b2Vec2(9.5f, 5.5f);

    _lasers.emplace_back(_world, toPixels(0), toPixels(0), 3.0f);

    /// Crear llave
    _keyOriginalPosition = b2Vec2(5.0f, 6.2f);
    ...
    /// Crear puerta
    _door.emplace_back(_world, toPixels(4.5), toPixels(10.32));
    ...
    _levelImage.setTexture("resources/Sprites/bloqueNivel2.png");

}

void Scene2::draw(sf::RenderTarget& target, sf::RenderStates states) const{
