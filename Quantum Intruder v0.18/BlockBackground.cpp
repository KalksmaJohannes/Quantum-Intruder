...
sf::Texture BlockBackground::_texture;
bool BlockBackground::_isTextureLoaded = false;
float BlockBackground::_width = toMeters(40.0f);
float BlockBackground::_height = toMeters(40.0f);

BlockBackground::BlockBackground(b2World& world, float x, float y){
...
void BlockBackground::loadTexture(){

    _texture.loadFromFile("resources/Sprites/BloqueFondo.png");
    _isTextureLoaded = true;

}

void BlockBackground::draw(sf::RenderTarget& target) const{
...
sf::FloatRect BlockBackground::getBounds() const{
